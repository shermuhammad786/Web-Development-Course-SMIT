...
export const likePost = async (req, res) => {
    ...
    try {
        ...
        if (!jisKoLikeKiya.likes.includes(likerID)) {
            ...
            res.json({
                status: true,
                message: `${jisNeLikeKiyaDetail.username} you like the post of ${jisKoLikeKiyaDetail.username}`,
                likedPost: likedPost
            })
            ...
            res.json({
                status: false,
                message: `${jisNeLikeKiyaDetail.username} you un liked the post of ${jisKoLikeKiyaDetail.username}`,
